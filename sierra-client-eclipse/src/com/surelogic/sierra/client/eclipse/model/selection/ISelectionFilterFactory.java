...
public interface ISelectionFilterFactory extends Comparable<ISelectionFilterFactory> {
   ...
   *          <code>null</code> if no previous filter (i.e., this is the first
   ...
   */
  boolean addWhereClauseIfUnusedFilter(Set<ISelectionFilterFactory> unused, StringBuilder b, boolean first, boolean usesJoin);
}
