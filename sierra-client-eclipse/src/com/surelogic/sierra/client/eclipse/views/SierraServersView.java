...
public final class SierraServersView extends AbstractSierraView<SierraServersMediator> {
  ...
  protected Action createPreferencesAction() {
    final Action serverInteractionAction = new Action(PREFERENCES_MSG, IAction.AS_PUSH_BUTTON) {
      @Override
      public void run() {
        final PreferenceDialog dialog = PreferencesUtil.createPreferenceDialogOn(null, PreferencesAction.SERVER_INTERACTION_ID,
