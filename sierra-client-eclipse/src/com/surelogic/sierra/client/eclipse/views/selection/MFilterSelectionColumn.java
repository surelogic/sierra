...
public final class MFilterSelectionColumn extends MColumn implements IFilterObserver {
  ...
  void updateReport() {
    ...
    f_totalCount.setText(SLUtility.toStringHumanWithCommas(total) + (total == 1 ? " Finding" : " Findings"));
    ...
    if (f_porousCount != null && !f_porousCount.isDisposed()) {
      if (f_reportContents.getItemCount() > 0) {
        ...
        String msg = (porousCount == 0 ? "No" : porousCountString) + (porousCount != 1 ? " findings" : " finding") + " selected";
