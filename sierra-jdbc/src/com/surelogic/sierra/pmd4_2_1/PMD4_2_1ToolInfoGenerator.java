package com.surelogic.sierra.pmd4_2_1;
 ...
 *
 */
public final class PMD4_2_1ToolInfoGenerator extends PMD1_0_0ToolInfoGenerator {
    private static final Logger log = Logger
            .getLogger(PMD4_2_1ToolInfoGenerator.class.getName());
    ...
    public static void generateTool(Connection conn) {
        PMD4_2_1ToolInfoGenerator handler = new PMD4_2_1ToolInfoGenerator(conn);
        SAXParser sp = XMLUtil.createSAXParser();
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        String rulesetFilenames = getRulesetNames(
                log,
                cl.getResourceAsStream("com/surelogic/sierra/pmd4_2_1/rulesets/rulesets.properties"));
        ...
        for (StringTokenizer st = new StringTokenizer(rulesetFilenames, ","); st
            ...
            XMLUtil.parseResource(
                    log,
                    sp,
                    cl.getResourceAsStream("com/surelogic/sierra/pmd4_2_1/"
                            + fileName), handler,
                    "Could not parse a PMD ruleset");
        }
    }

    private PMD4_2_1ToolInfoGenerator(Connection conn) {
        super(conn, "4.2.1");
    }
}
