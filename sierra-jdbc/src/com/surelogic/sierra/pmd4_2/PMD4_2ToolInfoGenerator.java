 ...
 *
 */
public final class PMD4_2ToolInfoGenerator extends PMD1_0_0ToolInfoGenerator {
    ...
    public static void generateTool(Connection conn) {
        ...
        String rulesetFilenames = getRulesetNames(
                log,
                cl.getResourceAsStream("com/surelogic/sierra/pmd4_2/rulesets/rulesets.properties"));
        ...
        for (StringTokenizer st = new StringTokenizer(rulesetFilenames, ","); st
            ...
            XMLUtil.parseResource(
                    log,
                    sp,
                    cl.getResourceAsStream("com/surelogic/sierra/pmd4_2/"
                            + fileName), handler,
