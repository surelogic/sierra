 ...
 *
 */
public final class PMD5_0_5ToolInfoGenerator extends PMD2_0_0ToolInfoGenerator {
    ...
    public static void generateTool(Connection conn) {
        ...
        String rulesetFilenames = getRulesetNames(
                log,
                cl.getResourceAsStream("com/surelogic/sierra/pmd5_0_5/rulesets/java/rulesets.properties"));
        ...
        for (StringTokenizer st = new StringTokenizer(rulesetFilenames, ","); st
            ...
            XMLUtil.parseResource(
                    log,
                    sp,
                    cl.getResourceAsStream("com/surelogic/sierra/pmd5_0_5/"
                            + fileName), handler,
