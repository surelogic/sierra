package com.surelogic.sierra.pmd4_2_4;
 ...
 *
 */
public final class PMD4_2_4ToolInfoGenerator extends PMD1_0_0ToolInfoGenerator {
    private static final Logger log = Logger
            .getLogger(PMD4_2_4ToolInfoGenerator.class.getName());
    ...
    public static void generateTool(Connection conn) {
        PMD4_2_4ToolInfoGenerator handler = new PMD4_2_4ToolInfoGenerator(conn);
        SAXParser sp = XMLUtil.createSAXParser();
        ClassLoader cl = Thread.currentThread().getContextClassLoader();
        String rulesetFilenames = getRulesetNames(
                log,
                cl.getResourceAsStream("com/surelogic/sierra/pmd4_2_4/rulesets/rulesets.properties"));
        ...
        for (StringTokenizer st = new StringTokenizer(rulesetFilenames, ","); st
            ...
            XMLUtil.parseResource(
                    log,
                    sp,
                    cl.getResourceAsStream("com/surelogic/sierra/pmd4_2_4/"
                            + fileName), handler,
                    "Could not parse a PMD ruleset");
        }
    }

    private PMD4_2_4ToolInfoGenerator(Connection conn) {
        super(conn, "4.2.4");
    }
}
