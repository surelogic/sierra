 ...
 *
 */
public final class PMD3_9ToolInfoGenerator extends PMD1_0_0ToolInfoGenerator {
    ...
    public static void generateTool(Connection conn) {
        ...
        String rulesetFilenames = getRulesetNames(
                log,
                cl.getResourceAsStream("com/surelogic/sierra/pmd3_9/rulesets.properties"));
        ...
        for (StringTokenizer st = new StringTokenizer(rulesetFilenames, ","); st
            ...
            XMLUtil.parseResource(
                    log,
                    sp,
                    cl.getResourceAsStream("com/surelogic/sierra/pmd3_9/"
                            + fileName), handler,
