 ...
 *
 */
public final class PMD4_1ToolInfoGenerator extends PMD1_0_0ToolInfoGenerator {
    ...
    public static void generateTool(Connection conn) {
        ...
        String rulesetFilenames = getRulesetNames(
                log,
                cl.getResourceAsStream("com/surelogic/sierra/pmd4_1/rulesets/rulesets.properties"));
        ...
        for (StringTokenizer st = new StringTokenizer(rulesetFilenames, ","); st
            ...
            XMLUtil.parseResource(
                    log,
                    sp,
                    cl.getResourceAsStream("com/surelogic/sierra/pmd4_1/"
                            + fileName), handler,
