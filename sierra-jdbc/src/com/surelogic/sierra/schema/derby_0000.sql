...
CREATE TABLE ARTIFACT (ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), SCAN_ID BIGINT NOT NULL, ARTIFACT_TYPE_ID BIGINT NOT NULL, PRIMARY_SOURCE_LOCATION_ID BIGINT NOT NULL, PRIORITY INTEGER, SEVERITY INTEGER, MESSAGE VARCHAR(32672), SCAN_NUMBER INTEGER)
<<>>
...
<<>>
CREATE TABLE SCAN_OVERVIEW (FINDING_ID BIGINT NOT NULL, SCAN_ID BIGINT NOT NULL, LINE_OF_CODE INTEGER NOT NULL, ARTIFACT_COUNT INTEGER NOT NULL, TOOL VARCHAR(255) NOT NULL, CU VARCHAR(32672))
<<>>
...
<<>>
CREATE TABLE FINDINGS_OVERVIEW (FINDING_ID BIGINT NOT NULL, PROJECT_ID BIGINT NOT NULL, AUDITED VARCHAR(3) NOT NULL, LAST_CHANGED TIMESTAMP, IMPORTANCE VARCHAR(10) NOT NULL, STATUS VARCHAR(9) NOT NULL, LINE_OF_CODE INTEGER, ARTIFACT_COUNT INTEGER, AUDIT_COUNT INTEGER NOT NULL, PROJECT VARCHAR(255) NOT NULL, PACKAGE VARCHAR(32672) NOT NULL, CLASS VARCHAR(32672) NOT NULL, TOOL VARCHAR(255), SUMMARY VARCHAR(32672) NOT NULL, CU VARCHAR(32672), FINDING_TYPE VARCHAR(32672), FINDING_TYPE_NAME VARCHAR(32672))
<<>>
-- ----------------------------------------------
-- DDL Statements for indexes
-- ----------------------------------------------
