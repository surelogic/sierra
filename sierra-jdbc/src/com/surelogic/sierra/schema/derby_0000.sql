...
<<>>
CREATE TABLE FINDINGS_OVERVIEW (FINDING_ID BIGINT NOT NULL, PROJECT_ID BIGINT NOT NULL, AUDITED VARCHAR(3) NOT NULL, LAST_CHANGED TIMESTAMP, IMPORTANCE VARCHAR(10) NOT NULL, STATUS VARCHAR(9) NOT NULL, LINE_OF_CODE INTEGER, ARTIFACT_COUNT INTEGER, AUDIT_COUNT INTEGER NOT NULL, PROJECT VARCHAR(255) NOT NULL, PACKAGE VARCHAR(32672) NOT NULL, CLASS VARCHAR(32672) NOT NULL, TOOL VARCHAR(255), SUMMARY VARCHAR(32672) NOT NULL, CU VARCHAR(32672), FINDING_TYPE VARCHAR(32672), FINDING_TYPE_NAME VARCHAR(32672), ASSURANCE_TYPE CHAR(1))
<<>>
-- ----------------------------------------------
-- DDL Statements for indexes
-- ----------------------------------------------
