...
public abstract class AbstractPMDToolInfoGenerator extends PMDRulesXMLReader {
    ...
    protected AbstractPMDToolInfoGenerator(Connection conn, String version) {
        try {
            ...
            throw new IllegalStateException(
                    "Could not build PMD tool info for v." + version, e);
        }
    }
    ...
    public static String getRulesetNames(Logger log, InputStream in) {
        ...
        try {
            ...
            log.log(Level.SEVERE, "Could not load ruleset filenames for PMD", e);
        }
