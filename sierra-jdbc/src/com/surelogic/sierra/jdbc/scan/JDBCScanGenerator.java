...
class JDBCScanGenerator implements ScanGenerator {
        ...
        try {
            ...
            for (final String name : timeseries) {
                ...
                if (q.select()) {
                    ...
                    rq.setId(new RecordRelationRecord.PK<TimeseriesRecord, ScanRecord>(
                            q, scan));
                    rq.insert();
                } else {
                    scan.delete();
    ...
    @Override
    public ScanGenerator externalFilter(final String filterString) {
        externalFilter = filterString;
        return this;
    }
