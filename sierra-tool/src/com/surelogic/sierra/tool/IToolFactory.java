...
public interface IToolFactory {
  ...
  /**
   * Initializes the factory If overridden, should call super.init()
   * 
   * @param toolHome
   *          The general directory for Sierra tool-related stuff
   * @param pluginDir
   *          The specific directory for this tool
   */
  ...
  /**
   * Creates an instance of the tool to do one scan Also creates an
   * ILazyArtifactGenerator appropriate to the Config settings for the results
   */
