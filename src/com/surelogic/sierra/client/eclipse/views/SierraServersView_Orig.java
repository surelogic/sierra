...
public final class SierraServersView_Orig extends AbstractSierraView<SierraServersMediator_Orig> {
	...
	protected SierraServersMediator_Orig createMorePartControls(final Composite parent) {
		...
		return new SierraServersMediator_Orig(this, serverList, newServer,
