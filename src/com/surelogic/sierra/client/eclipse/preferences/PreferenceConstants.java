...
public class PreferenceConstants extends AutoPerspectiveSwitchPreferences {
	...
	public static Importance showMarkersAtOrAboveImportance() {
		final String resultString = Activator.getDefault().getPreferenceStore()
				.getString(P_SIERRA_SHOW_MARKERS_AT_OR_ABOVE_IMPORTANCE);
	...
	public static void setToolMemoryMB(final int mb) {
		Activator.getDefault().getPreferenceStore().setValue(P_TOOL_MEMORY_MB,
				mb);
	}
	...
	public static ServerStatusSort getServerStatusSort() {
		final String sort = Activator.getDefault().getPreferenceStore()
	...
	public static ServerFailureReport getServerFailureReporting() {
		final String resultString = Activator.getDefault().getPreferenceStore()
				.getString(P_SERVER_FAILURE_REPORTING);
