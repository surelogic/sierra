...
public class CompareProjectScans implements IDatabaseTable {
	...
	public ReportTable generate(final ReportSettings report,
		...
		table.getColumns().addAll(
				Arrays.asList(new ColumnDataType[] { ColumnDataType.NUMBER,
						ColumnDataType.TEXT, ColumnDataType.TEXT, ColumnDataType.NUMBER,
						ColumnDataType.TEXT, ColumnDataType.TEXT, ColumnDataType.TEXT,
						ColumnDataType.DATE, ColumnDataType.TEXT, ColumnDataType.TEXT,
						ColumnDataType.NUMBER, ColumnDataType.NUMBER, ColumnDataType.TEXT,
						ColumnDataType.TEXT }));
