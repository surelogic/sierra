		...
		return ConnectionFactory
				.withUserReadOnly(new UserQuery<List<FilterSet>>() {
					...
					public List<FilterSet> perform(Query q, Server server,
						...
						FindingTypeManager ftMan;
						try {
							ftMan = FindingTypeManager.getInstance(q
									.getConnection());
							...
							Collections.sort(values,
									new Comparator<FilterSet>() {
										public int compare(FilterSet o1,
												FilterSet o2) {
