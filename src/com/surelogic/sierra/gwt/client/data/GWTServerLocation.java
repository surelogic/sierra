...
public class GWTServerLocation implements Cacheable, Serializable {
	 ...
	 * @param label
	 */
	public GWTServerLocation(final String label) {
		this.label = label;
		port = 13376;
		protocol = Protocol.HTTP;
	}

	public GWTServerLocation(final String label, final Protocol protocol,
	...
	public GWTServerLocation copy(final GWTServerLocation orig) {
		final GWTServerLocation l = new GWTServerLocation();
