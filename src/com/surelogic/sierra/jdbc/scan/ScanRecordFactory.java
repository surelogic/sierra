...
public final class ScanRecordFactory {
	...
	private static final String ARTIFACT_INSERT = "INSERT INTO ARTIFACT (SCAN_ID,ARTIFACT_TYPE_ID,PRIMARY_SOURCE_LOCATION_ID,PRIORITY,SEVERITY,MESSAGE,SCAN_NUMBER,ASSURANCE_TYPE) VALUES (?,?,?,?,?,?,?,?)";
