...
public class ScanRecordFactory {
	...
	private static final String COMPILATION_UNIT_INSERT = "INSERT INTO SIERRA.COMPILATION_UNIT (CLASS_NAME,PACKAGE_NAME) VALUES (?,?)";
	private static final String COMPILATION_UNIT_SELECT = "SELECT ID FROM SIERRA.COMPILATION_UNIT CU WHERE CU.CLASS_NAME = ? AND CU.PACKAGE_NAME = ?";
