...
public class FindingRecordFactory {
	...
	private static final String MATCH_UPDATE = "UPDATE LOCATION_MATCH SET FINDING_ID = ? AND REVISION = ? WHERE PROJECT_ID = ? AND HASH = ? AND CLASS_NAME = ? AND PACKAGE_NAME = ? AND FINDING_TYPE_ID = ?";
