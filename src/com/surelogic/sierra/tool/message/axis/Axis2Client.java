...
public class Axis2Client implements SierraService {
    ...
    public com.surelogic.sierra.tool.message.CommitAuditTrailResponse commitAuditTrails(
        ...
        try {
            return new CommitAuditTrailResponseConverter().convert(stub.commitAuditTrails(
                    new CommitAuditTrailRequestConverter().convert(audits)));
        } catch (RemoteException e) {
            throw wrapException(e);
        } catch (com.surelogic.sierra.tool.message.axis.ServerMismatchException e) {
            throw new com.surelogic.sierra.tool.message.ServerMismatchException(e);
        }
    }
    ...
    public com.surelogic.sierra.tool.message.AuditTrailResponse getAuditTrails(
        ...
        throws com.surelogic.sierra.tool.message.ServerMismatchException {
        try {
            return new AuditTrailResponseConverter().convert(stub.getAuditTrails(
                    new GetAuditTrailsConverter().convert(request)));
        } catch (RemoteException e) {
            throw wrapException(e);
        } catch (com.surelogic.sierra.tool.message.axis.ServerMismatchException e) {
            throw new com.surelogic.sierra.tool.message.ServerMismatchException(e);
    ...
    public com.surelogic.sierra.tool.message.Qualifiers getQualifiers(
        ...
        try {
            final GetQualifiersResponse response = stub.getQualifiers(new GetQualifiers());
    ...
    public com.surelogic.sierra.tool.message.SettingsReply getSettings(
        ...
        throws com.surelogic.sierra.tool.message.ServerMismatchException {
        try {
            return new SettingsReplyConverter().convert(stub.getSettings(
                    new GetSettingsConverter().convert(request)));
        } catch (RemoteException e) {
            throw wrapException(e);
        } catch (com.surelogic.sierra.tool.message.axis.ServerMismatchException e) {
            throw new com.surelogic.sierra.tool.message.ServerMismatchException(e);
    ...
    public com.surelogic.sierra.tool.message.MergeAuditTrailResponse mergeAuditTrails(
        ...
        throws com.surelogic.sierra.tool.message.ServerMismatchException {
        try {
            return new MergeAuditTrailResponseConverter().convert(stub.mergeAuditTrails(
                    new MergeAuditTrailsConverter().convert(seed)));
        } catch (RemoteException e) {
            throw wrapException(e);
        } catch (com.surelogic.sierra.tool.message.axis.ServerMismatchException e) {
            throw new com.surelogic.sierra.tool.message.ServerMismatchException(e);
    ...
    public com.surelogic.sierra.tool.message.GlobalSettings getGlobalSettings(com.surelogic.sierra.tool.message.GlobalSettingsRequest request) {
    	try {
    		final GetGlobalSettings in = new GetGlobalSetttings();
    		
    		stub.getGlobalSettings(request);
    ...
    public void writeGlobalSettings(com.surelogic.sierra.tool.message.GlobalSettings settings) {
    	try {
    		stub.getUid(new GetUid());
        } catch (RemoteException e) {
            throw wrapException(e);
        }
    }
    ...
    private static class SettingsReplyConverter implements Converter<GetSettingsResponse, com.surelogic.sierra.tool.message.SettingsReply> {
        public com.surelogic.sierra.tool.message.SettingsReply convert(
            ...
            final ProjectSettings[] projectSettings = reply.getProjectSettings();

            if (settings != null) {
                out.getSettings()
                   .addAll(arrayToList(settings, new SettingsConverter()));
            }

            if (projectSettings != null) {
                out.getProjectSettings()
                   .addAll(arrayToList(projectSettings,
                        new ProjectSettingsConverter()));
            }

            if (filterSets != null) {
                out.getFilterSets()
                   .addAll(arrayToList(filterSets, new FilterSetConverter()));
            }
    ...
    private static class SettingsConverter implements Converter<Settings, com.surelogic.sierra.tool.message.Settings> {
    ...
    private static class ProjectSettingsConverter implements Converter<ProjectSettings, com.surelogic.sierra.tool.message.ProjectSettings> {
    ...
    private static class FilterSetConverter implements Converter<FilterSet, com.surelogic.sierra.tool.message.FilterSet> {
        public com.surelogic.sierra.tool.message.FilterSet convert(FilterSet in) {
            ...
            if (entries != null) {
                out.getFilter()
                   .addAll(arrayToList(entries, new FilterEntryConverter()));
            }
    ...
    private static class FilterEntryConverter implements Converter<FilterEntry, com.surelogic.sierra.tool.message.FilterEntry> {
    ...
    private static class GetSettingsConverter implements Converter<com.surelogic.sierra.tool.message.SettingsRequest, GetSettings> {
    ...
    private static class AuditTrailResponseConverter implements Converter<GetAuditTrailsResponse, com.surelogic.sierra.tool.message.AuditTrailResponse> {
    ...
    private static class ObsoleteConverter implements Converter<TrailObsoletion, com.surelogic.sierra.tool.message.TrailObsoletion> {
    ...
    private static class AuditTrailUpdateConverter implements Converter<AuditTrailUpdate, com.surelogic.sierra.tool.message.AuditTrailUpdate> {
        public com.surelogic.sierra.tool.message.AuditTrailUpdate convert(
            ...
            out.setAudit(arrayToList(in.getAudit(), new MessageAuditConverter()));

            final Importance imp = in.getImportance();

            if (imp != null) {
                out.setImportance(com.surelogic.sierra.tool.message.Importance.valueOf(
                        imp.getValue()));
            }

            out.setMatch(arrayToList(in.getMatch(), new MessageMatchConverter()));
    ...
    private static class MessageAuditConverter implements Converter<Audit, com.surelogic.sierra.tool.message.Audit> {
        public com.surelogic.sierra.tool.message.Audit convert(Audit in) {
            ...
            out.setEvent(com.surelogic.sierra.tool.message.AuditEvent.valueOf(
                    in.getEvent().getValue()));
            out.setRevision(in.getRevision());
    ...
    private static class MessageMatchConverter implements Converter<Match, com.surelogic.sierra.tool.message.Match> {
    ...
    private static class GetAuditTrailsConverter implements Converter<com.surelogic.sierra.tool.message.GetAuditTrailRequest, GetAuditTrails> {
    ...
    private static class MergeAuditTrailResponseConverter implements Converter<MergeAuditTrailsResponse, com.surelogic.sierra.tool.message.MergeAuditTrailResponse> {
        public com.surelogic.sierra.tool.message.MergeAuditTrailResponse convert(
            ...
            final MergeAuditTrailResponse response = in.getMergeAuditTrailsResponse();
    ...
    private static class MergeAuditTrailsConverter implements Converter<com.surelogic.sierra.tool.message.MergeAuditTrailRequest, MergeAuditTrails> {
        public MergeAuditTrails convert(
            ...
            final List<com.surelogic.sierra.tool.message.Merge> merges = in.getMerge();
    ...
    private static class MergeConverter implements Converter<com.surelogic.sierra.tool.message.Merge, Merge> {
        public Merge convert(com.surelogic.sierra.tool.message.Merge in) {
            final Merge out = new Merge();
            out.setImportance(Importance.Factory.fromValue(
                    in.getImportance().name()));
            out.setSummary(in.getSummary());

            final List<com.surelogic.sierra.tool.message.Match> matches = in.getMatch();

            if (matches != null) {
                out.setMatch(collToArray(in.getMatch(),
                        new Match[matches.size()], new MatchConverter()));
            }
    ...
    private static class MatchConverter implements Converter<com.surelogic.sierra.tool.message.Match, Match> {
    ...
    private static class ScanConverter implements Converter<com.surelogic.sierra.tool.message.Scan, Scan9> {
        public Scan9 convert(com.surelogic.sierra.tool.message.Scan in) {
            ...
            scan.setToolOutput(new ToolOutputConverter().convert(
                    in.getToolOutput()));
    ...
    private static class ConfigConverter implements Converter<com.surelogic.sierra.tool.message.Config, Config> {
        public Config convert(com.surelogic.sierra.tool.message.Config in) {
            ...
            if (qualifiers != null) {
                out.setQualifiers(qualifiers.toArray(
                        new String[qualifiers.size()]));
            }
    ...
    private static class ToolOutputConverter implements Converter<com.surelogic.sierra.tool.message.ToolOutput, ToolOutput> {
        public ToolOutput convert(
            ...
            if (in.getArtifacts() != null) {
                final Collection<com.surelogic.sierra.tool.message.Artifact> inA =
                    in.getArtifacts().getArtifact();
            ...
            if (in.getErrors() != null) {
                final Collection<com.surelogic.sierra.tool.message.Error> inE = in.getErrors()
                                                                                  .getErrors();
            ...
            if (in.getMetrics() != null) {
                final Collection<com.surelogic.sierra.tool.message.ClassMetric> inM =
                    in.getMetrics().getClassMetric();
    ...
    private static class ErrorConverter implements Converter<com.surelogic.sierra.tool.message.Error, Error> {
    ...
    private static class ClassMetricConverter implements Converter<com.surelogic.sierra.tool.message.ClassMetric, ClassMetric> {
    ...
    private static class ArtifactConverter implements Converter<com.surelogic.sierra.tool.message.Artifact, Artifact> {
        public Artifact convert(com.surelogic.sierra.tool.message.Artifact in) {
            final Artifact out = new Artifact();
            final List<com.surelogic.sierra.tool.message.SourceLocation> additional =
                in.getAdditionalSources();
            ...
            out.setArtifactType(new ArtifactTypeConverter().convert(
                    in.getArtifactType()));
            out.setMessage(in.getMessage());
            out.setPrimarySourceLocation(new SourceLocationConverter().convert(
                    in.getPrimarySourceLocation()));
            out.setPriority(Priority.Factory.fromValue(in.getPriority().name()));
            out.setSeverity(Severity.Factory.fromValue(in.getSeverity().name()));

            return out;
        }
    }

    private static class ArtifactTypeConverter implements Converter<com.surelogic.sierra.tool.message.ArtifactType, ArtifactType> {
    ...
    private static class SourceLocationConverter implements Converter<com.surelogic.sierra.tool.message.SourceLocation, SourceLocation> {
        public SourceLocation convert(
            ...
            final com.surelogic.sierra.tool.message.IdentifierType type = in.getIdentifierType();

            if (type != null) {
                out.setIdentifierType(IdentifierType.Factory.fromValue(
                        type.name()));
            }
    ...
    private static class CommitAuditTrailResponseConverter implements Converter<CommitAuditTrailsResponse, com.surelogic.sierra.tool.message.CommitAuditTrailResponse> {
        public com.surelogic.sierra.tool.message.CommitAuditTrailResponse convert(
            CommitAuditTrailsResponse commit) {
            final CommitAuditTrailResponse old = commit.getCommitAuditTrailsResponse();
            final com.surelogic.sierra.tool.message.CommitAuditTrailResponse response =
                new com.surelogic.sierra.tool.message.CommitAuditTrailResponse();
    ...
    private static class CommitAuditTrailRequestConverter implements Converter<com.surelogic.sierra.tool.message.CommitAuditTrailRequest, CommitAuditTrails> {
        public CommitAuditTrails convert(
            ...
            final List<com.surelogic.sierra.tool.message.AuditTrail> auditTrail = in.getAuditTrail();

            if (auditTrail != null) {
                request.setAuditTrail(collToArray(auditTrail,
                        new SierraServiceBeanServiceStub.AuditTrail[auditTrail.size()],
                        new AuditTrailConverter()));
            }
    ...
    private static class AuditTrailConverter implements Converter<com.surelogic.sierra.tool.message.AuditTrail, AuditTrail> {
        public AuditTrail convert(
            ...
            final List<com.surelogic.sierra.tool.message.Audit> oldAudits = in.getAudits();

            if (oldAudits != null) {
                trail.setAudits(collToArray(oldAudits,
                        new Audit[oldAudits.size()], new AuditConverter()));
            }
    ...
    private static class AuditConverter implements Converter<com.surelogic.sierra.tool.message.Audit, SierraServiceBeanServiceStub.Audit> {
