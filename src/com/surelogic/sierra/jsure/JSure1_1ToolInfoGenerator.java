...
public class JSure1_1ToolInfoGenerator {
	...
	public static final String[] artifactTypes = {
		...
		"LockAnalysis_ds_FieldAccessOkayThreadConfined",
		...
		"UniquenessAssurance_aggregatedUniqueFields",
		"UniquenessAssurance_aggregatedUniqueParams",
		"UniquenessAssurance",
		...
		"EffectAssurance",
		"FINAL_AND_THREADSAFE",
		"VOLATILE_AND_THREADSAFE",
