...
<<>>
CREATE TABLE SERVER_LOCATION (ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), LABEL VARCHAR(255) NOT NULL, PROTOCOL VARCHAR(5) NOT NULL, HOST VARCHAR(2000), PORT INTEGER, CONTEXT_PATH VARCHAR(2000), SERVER_USER VARCHAR(255), PASSWORD VARCHAR(255), UUID CHAR(36))
<<>>
