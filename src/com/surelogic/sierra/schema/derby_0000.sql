...
<<>>
CREATE TABLE SERVER_LOCATION (UUID CHAR(36) NOT NULL, PROTOCOL VARCHAR(5) NOT NULL, HOST VARCHAR(2000), PORT INTEGER, CONTEXT_PATH VARCHAR(2000), SERVER_USER VARCHAR(255), PASSWORD VARCHAR(255), AUTOSYNC CHAR(1) NOT NULL, TEAMSERVER CHAR(1) NOT NULL)
<<>>
