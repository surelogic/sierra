...
<<>>
CREATE TABLE FINDING_CATEGORY (ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), UUID VARCHAR(32672) NOT NULL, NAME VARCHAR(32672) NOT NULL, DESCRIPTION VARCHAR(32672))
<<>>
...
<<>>
CREATE TABLE FINDING_TYPE (ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), UUID VARCHAR(32672) NOT NULL, NAME VARCHAR(32672) NOT NULL, SHORT_MESSAGE VARCHAR(32672), INFO VARCHAR(32672), CATEGORY_ID BIGINT)
<<>>
...
<<>>
CREATE TABLE SERVER_LOCATION (ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), LABEL VARCHAR(255) NOT NULL, PROTOCOL VARCHAR(5) NOT NULL, HOST VARCHAR(2000), PORT INTEGER, CONTEXT_PATH VARCHAR(2000), SERVER_USER VARCHAR(255), PASSWORD VARCHAR(255), AUTOSYNC CHAR(1) NOT NULL, UUID CHAR(36), TEAMSERVER CHAR(1) NOT NULL)
<<>>
CREATE TABLE SERVER_LOCATION_PROJECT (SERVER_ID BIGINT NOT NULL, PROJECT VARCHAR(2000) NOT NULL)
<<>>
...
<<>>
CREATE TABLE SIERRA_AUDIT (ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), FINDING_ID BIGINT NOT NULL, EVENT VARCHAR(10) NOT NULL, USER_ID BIGINT, DATE_TIME TIMESTAMP NOT NULL, VALUE VARCHAR(32672), REVISION BIGINT)
<<>>
...
<<>>
ALTER TABLE FINDING_CATEGORY ADD CONSTRAINT SQL081027164830420 PRIMARY KEY (ID)
<<>>
ALTER TABLE FINDING_CATEGORY ADD CONSTRAINT SQL081027164830421 UNIQUE (UUID)
<<>>
ALTER TABLE FINDING_CATEGORY ADD CONSTRAINT SQL081027164830422 UNIQUE (NAME)
<<>>
...
<<>>
ALTER TABLE SERVER_LOCATION ADD CONSTRAINT SQL081027164837800 PRIMARY KEY (ID)
<<>>
ALTER TABLE SERVER_LOCATION ADD CONSTRAINT SERVER_LOCATION_LABEL_U_CN UNIQUE (LABEL)
<<>>
ALTER TABLE SERVER_LOCATION_PROJECT ADD CONSTRAINT SQL081027164837870 PRIMARY KEY (SERVER_ID, PROJECT)
<<>>
ALTER TABLE SIERRA_AUDIT ADD CONSTRAINT SQL081027164829850 PRIMARY KEY (ID)
<<>>
...
<<>>
ALTER TABLE FINDING_TYPE ADD CONSTRAINT FT_FC_FK FOREIGN KEY (CATEGORY_ID) REFERENCES FINDING_CATEGORY (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
...
<<>>
ALTER TABLE SERVER_LOCATION_PROJECT ADD CONSTRAINT SLP_SERVER_FK FOREIGN KEY (SERVER_ID) REFERENCES SERVER_LOCATION (ID) ON DELETE CASCADE ON UPDATE NO ACTION
<<>>
...
<<>>
CREATE TABLE FINDINGS_OVERVIEW (FINDING_ID BIGINT NOT NULL, PROJECT_ID BIGINT NOT NULL, AUDITED VARCHAR(3) NOT NULL, LAST_CHANGED TIMESTAMP, IMPORTANCE VARCHAR(10) NOT NULL, STATUS VARCHAR(9) NOT NULL, LINE_OF_CODE INTEGER, ARTIFACT_COUNT INTEGER, AUDIT_COUNT INTEGER NOT NULL, PROJECT VARCHAR(255) NOT NULL, PACKAGE VARCHAR(32672) NOT NULL, CLASS VARCHAR(32672) NOT NULL, TOOL VARCHAR(255), SUMMARY VARCHAR(32672) NOT NULL, CU VARCHAR(32672), CATEGORY VARCHAR(32672), FINDING_TYPE VARCHAR(32672), ASSURANCE_TYPE CHAR(1))
<<>>
-- ----------------------------------------------
-- DDL Statements for indexes
-- ----------------------------------------------
