...
<<>>
CREATE TABLE SIERRA_AUDIT (UUID CHAR(36) NOT NULL, FINDING_ID BIGINT NOT NULL, EVENT VARCHAR(10) NOT NULL, USER_ID BIGINT, DATE_TIME TIMESTAMP NOT NULL, VALUE VARCHAR(32672), REVISION BIGINT)
<<>>
