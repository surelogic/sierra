...
CREATE TABLE PROJECT (
  ...
  SERVER_UUID        CHAR(36),
  SETTINGS_REVISION  BIGINT       DEFAULT 0
)
<<>>
...
CREATE TABLE FINDING_CATEGORY (
  ID          BIGINT         NOT NULL GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  UUID        VARCHAR(32672) UNIQUE NOT NULL,
...
CREATE TABLE PROJECT_FILTERS (
  PROJECT_ID      BIGINT  NOT NULL CONSTRAINT SETTINGS_PROJECT_FK REFERENCES PROJECT (ID) ON DELETE CASCADE,
