...
CREATE TABLE FINDING (
  ID                 BIGINT             NOT NULL GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  PROJECT_ID         BIGINT             NOT NULL CONSTRAINT FINDING_PROJECT_FK REFERENCES PROJECT (ID) ON DELETE CASCADE,
  OBSOLETED_BY_ID    BIGINT             CONSTRAINT FINDING_OBSOLETED_FINDING_FK REFERENCES FINDING (ID) ON DELETE CASCADE,
  UID                CHAR(36),
  IMPORTANCE         INT,
  REVISION           BIGINT
);
...
CREATE TABLE LOCATION_MATCH (
  PROJECT_ID         BIGINT              NOT NULL CONSTRAINT MATCH_PROJECT_FK REFERENCES PROJECT (ID) ON DELETE CASCADE,
  HASH               BIGINT              NOT NULL,
  PACKAGE_NAME       VARCHAR(32672)      NOT NULL,
  CLASS_NAME         VARCHAR(32672)      NOT NULL,
  FINDING_TYPE_ID    BIGINT              NOT NULL CONSTRAINT MATCH_FINDING_TYPE_FK REFERENCES FINDING_TYPE (ID),
  FINDING_ID         BIGINT              NOT NULL CONSTRAINT MATCH_FINDING_FK REFERENCES FINDING (ID) ON DELETE CASCADE,
  REVISION           BIGINT,
