...
<<>>
CREATE TABLE NOTIFICATION (TO_EMAIL VARCHAR(320) NOT NULL, SMTP_HOST VARCHAR(32672), SMTP_PORT INTEGER, SMTP_PASS VARCHAR(32672), SMTP_USER VARCHAR(32672), FROM_EMAIL VARCHAR(320))
<<>>
