...
CREATE TABLE SETTING_FILTERS (
  SETTINGS_ID     BIGINT  NOT NULL CONSTRAINT SETTINGS_SETTINGS_FK REFERENCES SETTINGS (ID) ON DELETE CASCADE,
...
CREATE TABLE EMAIL (
  EMAIL_ID BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
  ADDRESS  VARCHAR(320)
)
<<>>
