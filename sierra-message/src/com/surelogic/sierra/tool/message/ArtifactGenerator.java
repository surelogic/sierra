...
public interface ArtifactGenerator {
  ...
  public interface ArtifactBuilder {
    ...
    /**
     * Call this to build the primary source location. This method should only
     * be called once.
     * 
     * @return
     */
  ...
  public interface SourceLocationBuilder {
     ...
     * <code>com/surelogic/baz/Bar.java</code>, then the name of the compilation
     * unit is Bar.
     * 
     * @param compilation
     * @return
    ...
    /**
     * The package name of the class, usind <code>.</code> as the separator.
     * (ex. com.surelogic.baz)
     * 
     * @param packageName
     * @return
     */
