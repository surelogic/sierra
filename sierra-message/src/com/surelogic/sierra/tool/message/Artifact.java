...
public class Artifact {
  ...
  public Artifact(Builder builder) {
    ...
    additionalSources = new ArrayList<>(builder.sources);
  ...
  public static class Builder {
    ...
    Priority priority;
    Severity severity;
    final List<SourceLocation> sources = new ArrayList<>();
    String message;
    ...
    public Builder primarySourceLocation(SourceLocation primarySourceLocation) {
      this.primarySourceLocation = primarySourceLocation;
    ...
    private void validate() {
      if (artifactType == null) {
        throw new IllegalArgumentException("An artifact is being built with no artifact type.");
      }

      if (primarySourceLocation == null) {
        throw new IllegalArgumentException("An artifact is being build with no primary source location");
      }
    }
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + (additionalSources == null ? 0 : additionalSources.hashCode());
    result = prime * result + (artifactType == null ? 0 : artifactType.hashCode());
    result = prime * result + (message == null ? 0 : message.hashCode());
    result = prime * result + (primarySourceLocation == null ? 0 : primarySourceLocation.hashCode());
    result = prime * result + (priority == null ? 0 : priority.hashCode());
    result = prime * result + (scanNumber == null ? 0 : scanNumber.hashCode());
